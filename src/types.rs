...
///     address: "0x534b2f3A21130d7a60830c2Df862319e593943A3".parse().unwrap(),
///     network: Network::MonadTestnet,
/// };
///
/// assert_eq!(asset.address.to_string(), "0x534b2f3A21130d7a60830c2Df862319e593943A3");
/// ```
#[derive(Clone, Debug, Eq, PartialEq, Hash)]
...
/// };
///
/// assert_eq!(deployment.asset.address.to_string(), "0x534b2f3A21130d7a60830c2Df862319e593943A3");
